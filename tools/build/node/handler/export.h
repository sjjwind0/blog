...
extern "C" {
extern void JSOnAcceptNewClient(void* delegate, void* ipc_ptr, int ipc_id);
extern void JSOnClientClose(void* delegate, void* ipc_ptr, int ipc_id);
extern void JSOnConnect(void* delegate, void* ipc_ptr, int ipc_id);
extern void JSOnServerClose(void* delegate, void* ipc_ptr);
extern char* JSMethodFunc(void* param, const char* request);
extern void JSMethodCallback(void* param, int code, const char* response);
}
...
int CreateServer(void* ipc_ptr, const char* ipc_name, void* delegate) {
	if (_c_createServer_ptr != NULL) {
		return _c_createServer_ptr(ipc_ptr, ipc_name, (IPCServerInterface*)delegate);
	}
	return -1;
}
...
int OpenClient(void* ipc_ptr, const char* ipc_name, void* delegate) {
	if (_c_openClient_ptr != NULL) {
		return _c_openClient_ptr(ipc_ptr, ipc_name, (IPCClientInterface*)delegate);
	}
	return -1;
}
...
void RegisterMethod(void* ipc_ptr, int ipc_id, const char* method_name, void* method, void* param) {
	if (_c_registerMethod_ptr != NULL) {
		_c_registerMethod_ptr(ipc_ptr, ipc_id, method_name, (Method)method, param);
	}
}
...
void CallMethod(void* ipc_ptr, int ipc_id, const char* method_name, const char* request,
	...
	if (_c_callMethod_ptr != NULL) {
		_c_callMethod_ptr(ipc_ptr, ipc_id, method_name, request, (MethodCallback)callback, param);
	}
}
